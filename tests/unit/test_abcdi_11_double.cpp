...
TEST(test_abcdi_11_double, sp_double_value) {
    service_provider p;
    auto v = p.make_injected<TEST_T>();
    EXPECT_EQ(0, v);
}

TEST(test_abcdi_11_double, sp_double_const_value) {
    service_provider p;
    const auto v = p.make_injected<const TEST_T>();
    EXPECT_EQ(0, v);
}

TEST(test_abcdi_11_double, sp_doublereference) {
    service_provider p;
    auto & v = p.make_injected<TEST_T&>();
    EXPECT_EQ(0, v);
}

TEST(test_abcdi_11_double, sp_double_const_reference) {
    service_provider p;
    auto const& v = p.make_injected<TEST_T const&>();
    EXPECT_EQ(0, v);
}

TEST(test_abcdi_11_double, sp_double_pointer) {
    service_provider p;
    auto* v = p.make_injected<TEST_T*>();
    EXPECT_NE(nullptr, v);
    EXPECT_EQ(0, *v);
...
TEST(test_abcdi_11_double, sp_double_pointer_ref) {
    service_provider p;
...
TEST(test_abcdi_11_double, sp_double_shared_pointer) {
    service_provider p;
...
TEST(test_abcdi_11_double, sp_double_unique_pointer) {
    service_provider p;
