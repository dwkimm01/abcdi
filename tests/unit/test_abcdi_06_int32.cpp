...
TEST(test_abcdi_06_int32, sp_int32_t_value) {
    service_provider p;
    auto b = p.make_injected<TEST_T>();
    EXPECT_EQ(0, b);
}

TEST(test_abcdi_06_int32, sp_int32_t_const_value) {
    service_provider p;
    const auto b = p.make_injected<const TEST_T>();
    EXPECT_EQ(0, b);
}

TEST(test_abcdi_06_int32, sp_int32_t_reference) {
    service_provider p;
    auto & b = p.make_injected<TEST_T&>();
    EXPECT_EQ(0, b);
}

TEST(test_abcdi_06_int32, sp_int32_t_const_reference) {
    service_provider p;
    auto const& b = p.make_injected<TEST_T const&>();
    EXPECT_EQ(0, b);
}

TEST(test_abcdi_06_int32, sp_int32_t_pointer) {
    service_provider p;
    auto* b = p.make_injected<TEST_T*>();
    EXPECT_NE(nullptr, b);
    EXPECT_EQ(0, *b);
...
TEST(test_abcdi_06_int32, sp_int16_t_pointer_ref) {
    service_provider p;
    auto* & b = p.make_injected<TEST_T* &>();
    EXPECT_NE(nullptr, b);
    EXPECT_EQ(0, *b);
...
TEST(test_abcdi_06_int32, sp_int32_t_shared_pointer) {
    service_provider p;
...
TEST(test_abcdi_06_int32, sp_int32_t_unique_pointer) {
    service_provider p;
